...
lm_camera_matrix = np.array([[385.369934082031, 0.0, 321.181030273438],
                             [0.0, 385.369934082031, 239.649688720703],
                             [ 0.0, 0.0, 1.0]], dtype=np.float32)   #####~ 修改相机内参

# lm_camera_matrix = np.array([
#     [606.3062744140625, 0.0, 321.70147705078125],
#     [0.0, 605.3773193359375, 243.7819061279297],
#     [0.0, 0.0, 1.0]
# ], dtype=np.float32)
...
#vertices for Linemod objects   #####~
lm_vertices = np.array([
    [-37.50000, -11.50000,  -7.00000],
    [-15.00000, -30.00000,  -7.50000],
    [-30.00000, -7.50000,  -15.00000],
    [-7.50000, -15.00000,  -30.00000],
    [-37.50000, -7.00000,  -11.50000],
    [-11.50000, -7.00000,  -37.50000],
    [-10.00000, -10.00000,  -10.00000],
    [-10.00000, -10.00000,  -10.00000],
    [-10.00000, -10.00000,  -10.00000],
    [-15.00000, -15.00000,  -30.00000],
    [-15.00000, -30.00000,  -15.00000],
    [-0.000001, -17.50000,  -14.00000],
    [-14.00000, -17.50000,  -17.50000],
    [-14.50000, -17.50000,  -0.00000],
    [-15.00000, -30.00000,  -15.00000],
    [-15.00000, -15.00000,  -30.00000],
    [-15.00000, -30.00000,  -15.00000],
    [-15.00000, -30.00000,  -15.00000],   
...
def draw_obj_pose(origin_img, dets, class_names, class_to_cuboid, camera_matrix, conf_thres=0.85):   
    ...
    for det in dets:
        ...
        if score>conf_thres:
            ...
            tx =  translation_vec[2]+82
            ty = -translation_vec[0]
            tz = -translation_vec[1]
            ...
            #Labels on cuboid
            text = '{}:{:.1f}%'.format(class_names[cls], score * 100)
            print("class and P:",text)
            print("Rotation:")
            print(rotation_mat)
            print("Transform:",tx,ty,tz)
            print("Transform:", translation_vec[0], translation_vec[1], translation_vec[2])
            print("——————————————————————————————————")   
            txt_color = (0, 0, 0) if np.mean(_COLORS[cls]) > 0.5 else (255, 255, 255)
            font = cv2.FONT_HERSHEY_SIMPLEX
            txt_size = cv2.getTextSize(text, font, 0.4, 1)[0]
            ...
            cv2.putText(origin_img, text, (x0, y0 + txt_size[1]), font, 0.4, txt_color, thickness=1)
    return origin_img,rotation_mat,tx,ty,tz
